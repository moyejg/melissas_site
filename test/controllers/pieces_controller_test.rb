...
class PiecesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create piece" do
    assert_difference('Piece.count') do
      post pieces_url, params: { piece: { description: @piece.description, name: @piece.name, price: @piece.price, quantity: @piece.quantity } }
    end
  ...
  test "should update piece" do
    patch piece_url(@piece), params: { piece: { description: @piece.description, name: @piece.name, price: @piece.price, quantity: @piece.quantity } }
